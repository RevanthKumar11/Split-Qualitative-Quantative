...
app.post('/product',async (req,res)=>{
    ...
    try {
        ...
        ordermail(customerName, modelName, rate, image, phoneNumber, adderss, 'sathish29702@gmail.com', 'Order')
...
app.delete('/cancleOrder/:id/:userMail',async (req,res)=>{
    ...
    ordermail(findproduct.customerName, findproduct.modelName, findproduct.rate, findproduct.image, findproduct.phoneNumber, findproduct.adderss, 'sathish29702@gmail.com', `your order is canceled from ${findproduct.customerName}`)
